  ...
  void _onRefreshAll() async {
    ...
    if (this.mounted) {
      setState(() {
        ...
        var findprov = Provider.of<FindoutProvider>(context, listen: false);
        search(findprov.token, widget.selectedarea, widget.selectedcity,
            widget.main_cat, null, context);
      });
      _refreshController.refreshCompleted();
    }
  }

  void _onRefreshWithOutLoding() async {
    // monitor network fetch
    if (this.mounted) {
      setState(() {
        list.clear();
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: findprov.itemListAds.length == 0
                      ? Container(
                          height: 200,
                        )
                      : CustomCarouselSlider(
                          items: findprov.itemListAds,
                          height: 200,
                          subHeight: 50,
                          width: width,
                          autoplay: true,
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    itemCount: widget.main_cat.sub!.length + 1,
                    shrinkWrap: true,
                    // reverse: true,
                          ...
                          : i == widget.main_cat.sub!.length
                              ? InkWell(
                                  onTap: () {
                                    ...
                                    setState(() {
                                      ...
                                      widget.main_cat.sub![0].checked = true;
                                      sub_cat = widget.main_cat.sub![0];
                                      // tappedIndex = i;
                                    });
                                    ...
                                    for (var k = 0;
                                        k < widget.search_list.length;
                                        k++) {
                                      print("aaa${list.length}");
                                      print(
                                          "aaabb${widget.search_list[k].mainCategory}////${widget.main_cat.sub![0].title}");
                                      if (widget.search_list[k].subCategory ==
                                          widget.main_cat.sub![0].title) {
                                        setState(() {
                                          list.add(widget.search_list[k]);
                                          print(
                                              "aaa${widget.search_list[k].title}");
                                        });
                                      }
                                    }
                                    _onRefresh();
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Container(
                                      width: widget.main_cat.sub![0].title!
                                                  .length >
                                              10
                                          ? 140.w
                                          : 100.w,
                                      ...
                                      decoration: BoxDecoration(
                                        color: widget.main_cat.sub![0].checked!
                                            ? AppColors.blueW2Color
                                            : AppColors.whiteColor,
                                        // tappedIndex == i ? AppColors.blueW2Color : AppColors.whiteColor,
                                        borderRadius: const BorderRadius.all(
                              ...
                              : InkWell(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Container(
                                      width: widget.main_cat.sub![i].title!
                                                  .length >
                                              10
                                          ? 140.w
                                          : 100.w,
                      ...
                      InkWell(
                        onTap: () {
                          setState(() {
                            ...
                            if (clickMostWatched) {
                              list.sort(
                                  (b, a) => a.counter!.compareTo(b.counter!));
                            } else {
                              list.sort((b, a) =>
                                  a.is_special!.compareTo(b.is_special!));
                            }
                          });
                        },
                        child: Row(
                ...
                children: [
                  ...
                  LikeButton(
                    ...
                    onTap: (bool isLiked) async {
                      PlaySound().play();
                      var findprov =
                          Provider.of<FindoutProvider>(context, listen: false);

                      setState(() {
                        widget
                            .search_list[widget.search_list
                      ...
                      findprov.addfav(findprov.token, list.id!, 0, context);
                      checked == true ? _onRefreshAll() : _onRefresh();
                      return !isLiked;
                    },
