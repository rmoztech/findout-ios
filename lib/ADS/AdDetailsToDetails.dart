        ...
        child: Column(
            children: [
                    ...
                    onTap: (){
                      showDialog(
                        ...
                        builder: (context) => RatingDialog(
                          ...
                          // your app's logo?
                          image:
                          widget.list.images!.length==0?   Container(
                            // width: 50,
                            height: 150,
                            ...
                            decoration: BoxDecoration(
                              ...
                              image:  DecorationImage(
                                image: NetworkImage(widget.list.imagestring![0]),
                                fit: BoxFit.cover,
                              ),
                              border: Border.all(width: 0.5, color: const Color(0xffc8c8c8)),
                            ),
             ...
             Text(
              ...
              widget.list.about_place==null?Container():      Container(
                width: width.w,
                // height: height.h,
              ...
              widget.list.about_place==null?Container():       SizedBox(height: 10.h,),
              widget.list.about_place==null?Container():    HtmlWidget('${widget.list.about_place}'),
