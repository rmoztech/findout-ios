    ...
    showCupertinoModalBottomSheet(
      ...
      builder: (context) => GoogleMap(
        initialCameraPosition: CameraPosition(
            target: LatLng(double.parse(widget.list.location!.lat!),
                double.parse(widget.list.location!.long!)),
            zoom: 14),
        markers: [
          Marker(
              markerId: MarkerId('${widget.list.id}'),
              infoWindow: InfoWindow(
                title: widget.list.title.toString(),
              ),
              position: LatLng(double.parse(widget.list.location!.lat!),
                  double.parse(widget.list.location!.long!)))
        ].toSet(),
      ),
    );
        ...
        children: [
                  ...
                  showDialog(
                    ...
                    builder: (context) => RatingDialog(
                          ...
                          : Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image:
                                      NetworkImage(widget.list.imagestring![0]),
                                  fit: BoxFit.cover,
                                ),
                                border: Border.all(
                                    width: 0.5, color: const Color(0xffc8c8c8)),
                      ...
                      onSubmitted: (response) {
                        ...
                        findprov.rate(findprov.token, widget.list.id.toString(),
                            response.rating, "${response.comment}", context);
                      },
                    ),
                  );
                },
          ...
          widget.list.details == null
              ...
              : Padding(
                  ...
                  child: Text.rich(TextSpan(
                    children: <InlineSpan>[
                      TextSpan(
                        text: widget.list.details!.length > 170
                            ? widget.list.details!.substring(0, 170) + "..."
                            : widget.list.details,
                        style: TextStyle(
                          fontFamily: 'Cairo',
                          fontSize: 12.sp,
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  widget.list.phone == null
                      ? Container()
                      : InkWell(
                          onTap: () {
                            launch("tel:${widget.list.phone}");
                          },
                          child: Container(
                            width: 30,
                            height: 30,
                  ...
                  (widget.list.timeIn == null && widget.list.timeOut == null)
                      ? Container()
                      : SvgPicture.string(
                  ...
                  Text(
                    widget.list.timeIn == null ? "" : 'Access'.tr(),
                    style: TextStyle(
                      fontFamily: 'Cairo',
                      fontSize: 8.sp,
                      color: AppColors.gryColor,
                  ...
                  Text(
                    widget.list.timeIn == null ? "" : '${widget.list.timeIn}',
                    style: TextStyle(
                      fontFamily: 'Cairo',
                      fontSize: 8.sp,
                  ...
                  Text(
                    widget.list.timeOut == null ? "" : 'Exit'.tr(),
                    style: TextStyle(
                      fontFamily: 'Cairo',
                      fontSize: 8.sp,
                      color: AppColors.gryColor,
                  ...
                  Text(
                    widget.list.timeOut == null ? "" : '${widget.list.timeOut}',
                    style: TextStyle(
                      fontFamily: 'Cairo',
                      fontSize: 8.sp,
                      color: AppColors.blueW2Color,
                  ...
                  Text(
                    double.parse(widget.list.avgRates!).toStringAsFixed(1),
                    style: TextStyle(
                      fontFamily: 'Cairo',
                      fontSize: 12.sp,
                      color: AppColors.blackColor,
          ...
          (widget.list.instagram == null &&
                  widget.list.twitter == null &&
                  widget.list.facebook == null)
              ? Container()
              : Container(
                  width: width.w,
                  height: 70.h,
                                    ...
                                    PageRouteBuilder(
                                      ...
                                      pageBuilder: (BuildContext context,
                                          ...
                                          Animation<double>
                                              secondaryAnimation) {
                                        return WebPage(
                                            widget.list.instagram.toString());
                                      },
                                    ),
                                  );
                                },
