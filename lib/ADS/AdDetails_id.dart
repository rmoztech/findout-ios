...
class _AdDetailsIDState extends State<AdDetailsID> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body:list.length==0?Container(height: height,child: Center(child: Text("NoData".tr())),): Column(
        children: [
          SizedBox(
            height: 20.h,
          ),
                ...
                onTap: () {
                  showDialog(
                    ...
                    builder: (context) => RatingDialog(
                      ...
                      // your app's logo?
                      image:
                      list[0].images!.length==0?   Container(
                        // width: 50,
                        height: 150,
                        ...
                        decoration: BoxDecoration(
                          ...
                          image:  DecorationImage(
                            image: NetworkImage(list[0].imagestring![0]),
                            fit: BoxFit.cover,
                          ),
                          border: Border.all(width: 0.5, color: const Color(0xffc8c8c8)),
                        ),
          ...
          Text(
            list[0].title.toString(), //     'فندق هيلتون',
            style: TextStyle(
              fontFamily: 'Cairo',
              fontSize: 16.sp,
          ...
          list[0].details == null ? Text(" "):   Padding(
        ...
        child: Text.rich(TextSpan(
          ...
          (list[0].instagram == null&& list[0].twitter == null&& list[0].facebook == null)
              ? Container()
              :     Container(
            width: width.w,
            height: 70.h,
          ...
          Expanded(child: PinterestGrid(list[0])),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return StaggeredGridView.countBuilder(
      ...
      itemBuilder: (context, index) {
        return index==list.imagestring!.length?InkWell(
          onTap: () {
            pushNewScreen(
              context,
        ...
        child: ClipRRect(
          ...
          child: Image.network(list.imagestring![index], fit: BoxFit.cover),
        ),
      );},
